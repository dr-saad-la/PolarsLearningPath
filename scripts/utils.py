...
def update_pip():
    ...
    if current_version == latest_version:
        ...
        try:
            ...
            print(
                f"pip has been successfully updated from {current_version} to {latest_version}."  # noqa: E501
            )
...
def install_faker():
    """
    Installs the Faker package if it is not already installed in the current Python environment.  # noqa: E501
